...
def makePlots(inputfile,rerollfile,recoBins,rollingBins,recobw,rb,category):
    ...
    sbSlice=[[0,0]]*histoDict["embedded"].GetNbinsX()
    ...
    for name in histoDict.keys():
        ...
        newslice = 0
        for bn in range(0,histo.GetNbinsX()):
            #calculating SB for each slice

            if (bn%len(recoBins) in sbbins):
                print "calculating sb on bin",bn
                if ("ggH"or"qqH") in name:
                    sbSlice[bn][0]=sbSlice[bn][0]+histoDict[name].GetBinContent(bn)
                if ("embedded"or"ZL"or"TTT"or"TTL"or"STT"or"STL"or"jet"or"VVT"or"VVL") in name:
                    sbSlice[bn][1]=sbSlice[bn][1]+histoDict[name].GetBinContent(bn)
            else:
                sbSlice[bn][0]=1
                sbSlice[bn][1]=1
    print sbSlice
    for name in histoDict.keys():
        ...
        for bn in range(0,histo.GetNbinsX()):
            ...
            for nbn in range(0,len(recoBins)+1):
                ...
                if (bn%len(recoBins) in sbbins):
                    print sbSlice[bn][0],sbSlice[bn][1]
                    weight = float(sbSlice[bn][0])/float(sbSlice[bn][0]+sbSlice[bn][1])
                    rerolledDict[name].SetBinContent(nbn,rerolledDict[name].GetBinContent(nbn)*(weight))
                    rerolledDict[name].SetBinError(nbn,np.sqrt((rerolledDict[name].GetBinError(nbn))**2+(histo.GetBinError(bn))**2)*(weight))
    ...
    for histo in rerolledDict.keys():
        ...
        for bn in range(0,rerolledDict[histo].GetNbinsX()+1):
            #print "scaling histo new value",rerolledDict[histo].GetBinContent(bn),"    times  ",sbweight[bn]
            rerolledRebinned[histo].SetBinContent(bn,rerolledDict[histo].GetBinContent(bn)/recobw[bn])
            rerolledRebinned[histo].SetBinError(bn,rerolledDict[histo].GetBinError(bn)/recobw[bn])
            rerolledDict[histo].SetBinContent(bn,rerolledDict[histo].GetBinContent(bn)/recobw[bn])
            rerolledDict[histo].SetBinError(bn,rerolledDict[histo].GetBinError(bn)/recobw[bn])
        rerolledRebinned[histo].Write()
...
def main():
    ...
    mt_0jet_PTH_0_10_2016  = mt_0jet_PTH_0_10_2016_prefit
    mt_0jet_PTH_GE10_2016  = mt_0jet_PTH_GE10_2016_prefit
    mt_boosted_1J_2016     = mt_boosted_1J_2016_prefit
    mt_boosted_GE2J_2016   = mt_boosted_GE2J_2016_prefit
    mt_vbf_PTH_0_200_2016  = mt_vbf_PTH_0_200_2016_prefit
    mt_vbf_PTH_GE_200_2016 = mt_vbf_PTH_GE_200_2016_prefit
    ...
    mt_0jet_PTH_0_10_2016_sb  = mt_0jet_PTH_0_10_2016_subplot
    mt_0jet_PTH_GE10_2016_sb  = mt_0jet_PTH_GE10_2016_subplot
    mt_boosted_1J_2016_sb     = mt_boosted_1J_2016_subplot
    mt_boosted_GE2J_2016_sb   = mt_boosted_GE2J_2016_subplot
    mt_vbf_PTH_0_200_2016_sb  = mt_vbf_PTH_0_200_2016_subplot
    mt_vbf_PTH_GE_200_2016_sb = mt_vbf_PTH_GE_200_2016_subplot
    ...
    mt_0jet_PTH_0_10_2017  = mt_0jet_PTH_0_10_2017_prefit
    mt_0jet_PTH_GE10_2017  = mt_0jet_PTH_GE10_2017_prefit
    mt_boosted_1J_2017     = mt_boosted_1J_2017_prefit
    mt_boosted_GE2J_2017   = mt_boosted_GE2J_2017_prefit
    mt_vbf_PTH_0_200_2017  = mt_vbf_PTH_0_200_2017_prefit
    mt_vbf_PTH_GE_200_2017 = mt_vbf_PTH_GE_200_2017_prefit
    ...
    mt_0jet_PTH_0_10_2017_sb  = mt_0jet_PTH_0_10_2017_subplot
    mt_0jet_PTH_GE10_2017_sb  = mt_0jet_PTH_GE10_2017_subplot
    mt_boosted_1J_2017_sb     = mt_boosted_1J_2017_subplot
    mt_boosted_GE2J_2017_sb   = mt_boosted_GE2J_2017_subplot
    mt_vbf_PTH_0_200_2017_sb  = mt_vbf_PTH_0_200_2017_subplot
    mt_vbf_PTH_GE_200_2017_sb = mt_vbf_PTH_GE_200_2017_subplot
    #Merge the categories
    print "merging the categories"
    ...
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    mt_0jet_PTH_0_10_2018_prefit  = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"mt_0jet_PTH_0_10_2016_prefit")                                                             

    rollingBins = [30.0,40.0,50.0,60.0,70.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    mt_0jet_PTH_GE10_2018_prefit  = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"mt_0jet_PTH_GE10_2016_prefit")

    rollingBins = [0.0,60.0,120.0,200.0,250.0,300.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    mt_boosted_1J_2018_prefit     = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"mt_boosted_1J_2016_prefit") 

    rollingBins=[0.0,60.0,120.0,200.0,250.0,300.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    mt_boosted_GE2J_2018_prefit   = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"mt_boosted_GE2J_2016_prefit")                                                                           

    rollingBins=[350.0,700.0,1000.0,1500.0,1800.0,10000.0]
    #recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    mt_vbf_PTH_0_200_2018_prefit  = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"mt_vbf_PTH_0_200_2016_prefit")

    rollingBins = [350.0,700.0,1200.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    mt_vbf_PTH_GE_200_2018_prefit = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"mt_vbf_PTH_GE_200_2016_prefit")                                                   

    #Rebin the histograms 
    print "combining bins"
    #mt_0jet_PTH_0_10_2018  = reBin(rb,mt_0jet_PTH_0_10_2016_prefit,"mt_0jet_PTH_0_10_2016_prefit")       
    #mt_0jet_PTH_GE10_2018  = reBin(rb,mt_0jet_PTH_GE10_2016_prefit,"mt_0jet_PTH_GE10_2016_prefit")
    #mt_boosted_1J_2018     = reBin(rb,mt_boosted_1J_2016_prefit,"mt_boosted_1J_2016_prefit") 
    #mt_boosted_GE2J_2018   = reBin(rb,mt_boosted_GE2J_2016_prefit,"mt_boosted_GE2J_2016_prefit")           
    #mt_vbf_PTH_0_200_2018  = reBin(rb,mt_vbf_PTH_0_200_2016_prefit,"mt_vbf_PTH_0_200_2016_prefit")
    #mt_vbf_PTH_GE_200_2018 = reBin(rb,mt_vbf_PTH_GE_200_2016_prefit,"mt_vbf_PTH_GE_200_2016_prefit")                                                     


    mt_0jet_PTH_0_10_2018  = mt_0jet_PTH_0_10_2016_prefit
    mt_0jet_PTH_GE10_2018  = mt_0jet_PTH_GE10_2016_prefit
    mt_boosted_1J_2018     = mt_boosted_1J_2016_prefit
    mt_boosted_GE2J_2018   = mt_boosted_GE2J_2016_prefit
    mt_vbf_PTH_0_200_2018  = mt_vbf_PTH_0_200_2016_prefit
    mt_vbf_PTH_GE_200_2018 = mt_vbf_PTH_GE_200_2016_prefit
    ...
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    mt_0jet_PTH_0_10_2018_subplot  = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"mt_0jet_PTH_0_10_2016_prefit")                                                             

    rollingBins = [30.0,40.0,50.0,60.0,70.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    mt_0jet_PTH_GE10_2018_subplot  = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"mt_0jet_PTH_GE10_2016_prefit")

    rollingBins = [0.0,60.0,120.0,200.0,250.0,300.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    mt_boosted_1J_2018_subplot     = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"mt_boosted_1J_2016_prefit") 

    rollingBins=[0.0,60.0,120.0,200.0,250.0,300.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    mt_boosted_GE2J_2018_subplot   = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"mt_boosted_GE2J_2016_prefit")                                                                           

    rollingBins=[350.0,700.0,1000.0,1500.0,1800.0,10000.0]
    #recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    mt_vbf_PTH_0_200_2018_subplot  = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"mt_vbf_PTH_0_200_2016_prefit")

    rollingBins = [350.0,700.0,1200.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    mt_vbf_PTH_GE_200_2018_subplot = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"mt_vbf_PTH_GE_200_2016_prefit")                                                   
    #Rebin the histograms 
    print "combining bins"
    #mt_0jet_PTH_0_10_2018_sb = reBin(rb,mt_0jet_PTH_0_10_2016_subplot,"mt_0jet_PTH_0_10_2016_subplot")       
    #mt_0jet_PTH_GE10_2018_sb = reBin(rb,mt_0jet_PTH_GE10_2016_subplot,"mt_0jet_PTH_GE10_2016_subplot")
    #mt_boosted_1J_2018_sb = reBin(rb,mt_boosted_1J_2016_subplot,"mt_boosted_1J_2016_subplot") 
    #mt_boosted_GE2J_2018_sb = reBin(rb,mt_boosted_GE2J_2016_subplot,"mt_boosted_GE2J_2016_subplot")           
    #mt_vbf_PTH_0_200_2018_sb = reBin(rb,mt_vbf_PTH_0_200_2016_subplot,"mt_vbf_PTH_0_200_2016_subplot")
    #mt_vbf_PTH_GE_200_2018_sb = reBin(rb,mt_vbf_PTH_GE_200_2016_subplot,"mt_vbf_PTH_GE_200_2016_subplot")                                                     
    mt_0jet_PTH_0_10_2018_sb  = mt_0jet_PTH_0_10_2016_subplot
    mt_0jet_PTH_GE10_2018_sb  = mt_0jet_PTH_GE10_2016_subplot
    mt_boosted_1J_2018_sb     = mt_boosted_1J_2016_subplot
    mt_boosted_GE2J_2018_sb   = mt_boosted_GE2J_2016_subplot
    mt_vbf_PTH_0_200_2018_sb  = mt_vbf_PTH_0_200_2016_subplot
    mt_vbf_PTH_GE_200_2018_sb = mt_vbf_PTH_GE_200_2016_subplot
    #Merge the categories
    print "merging the categories"
    ...
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    tt_0jet_PTH_0_10_2018_prefit  = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"tt_0jet_PTH_0_10_2016_prefit")                                                             

    rollingBins = [30.0,40.0,50.0,60.0,70.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    tt_0jet_PTH_GE10_2018_prefit  = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"tt_0jet_PTH_GE10_2016_prefit")

    rollingBins = [0.0,60.0,120.0,200.0,250.0,300.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    tt_boosted_1J_2018_prefit     = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"tt_boosted_1J_2016_prefit") 

    rollingBins=[0.0,60.0,120.0,200.0,250.0,300.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    tt_boosted_GE2J_2018_prefit   = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"tt_boosted_GE2J_2016_prefit")                                                                           

    rollingBins=[350.0,700.0,1000.0,1500.0,1800.0,10000.0]
    #recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    tt_vbf_PTH_0_200_2018_prefit  = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"tt_vbf_PTH_0_200_2016_prefit")

    rollingBins = [350.0,700.0,1200.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    tt_vbf_PTH_GE_200_2018_prefit = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"tt_vbf_PTH_GE_200_2016_prefit")                                                   

    #Rebin the histograms 
    print "combining bins"
    #tt_0jet_PTH_0_10_2018  = reBin(rb,tt_0jet_PTH_0_10_2016_prefit,"tt_0jet_PTH_0_10_2016_prefit")       
    #tt_0jet_PTH_GE10_2018  = reBin(rb,tt_0jet_PTH_GE10_2016_prefit,"tt_0jet_PTH_GE10_2016_prefit")
    #tt_boosted_1J_2018     = reBin(rb,tt_boosted_1J_2016_prefit,"tt_boosted_1J_2016_prefit") 
    #tt_boosted_GE2J_2018   = reBin(rb,tt_boosted_GE2J_2016_prefit,"tt_boosted_GE2J_2016_prefit")           
    #tt_vbf_PTH_0_200_2018  = reBin(rb,tt_vbf_PTH_0_200_2016_prefit,"tt_vbf_PTH_0_200_2016_prefit")
    #tt_vbf_PTH_GE_200_2018 = reBin(rb,tt_vbf_PTH_GE_200_2016_prefit,"tt_vbf_PTH_GE_200_2016_prefit")                                                     


    tt_0jet_PTH_0_10_2018  = tt_0jet_PTH_0_10_2016_prefit
    tt_0jet_PTH_GE10_2018  = tt_0jet_PTH_GE10_2016_prefit
    tt_boosted_1J_2018     = tt_boosted_1J_2016_prefit
    tt_boosted_GE2J_2018   = tt_boosted_GE2J_2016_prefit
    tt_vbf_PTH_0_200_2018  = tt_vbf_PTH_0_200_2016_prefit
    tt_vbf_PTH_GE_200_2018 = tt_vbf_PTH_GE_200_2016_prefit
    ...
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    tt_0jet_PTH_0_10_2018_subplot  = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"tt_0jet_PTH_0_10_2016_prefit")                                                             

    rollingBins = [30.0,40.0,50.0,60.0,70.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    tt_0jet_PTH_GE10_2018_subplot  = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"tt_0jet_PTH_GE10_2016_prefit")

    rollingBins = [0.0,60.0,120.0,200.0,250.0,300.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    tt_boosted_1J_2018_subplot     = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"tt_boosted_1J_2016_prefit") 

    rollingBins=[0.0,60.0,120.0,200.0,250.0,300.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    tt_boosted_GE2J_2018_subplot   = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"tt_boosted_GE2J_2016_prefit")                                                                           

    rollingBins=[350.0,700.0,1000.0,1500.0,1800.0,10000.0]
    #recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    tt_vbf_PTH_0_200_2018_subplot  = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"tt_vbf_PTH_0_200_2016_prefit")

    rollingBins = [350.0,700.0,1200.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    tt_vbf_PTH_GE_200_2018_subplot = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"tt_vbf_PTH_GE_200_2016_prefit")                                                   
    #Rebin the histograms 
    print "combining bins"
    #tt_0jet_PTH_0_10_2018_sb = reBin(rb,tt_0jet_PTH_0_10_2016_subplot,"tt_0jet_PTH_0_10_2016_subplot")       
    #tt_0jet_PTH_GE10_2018_sb = reBin(rb,tt_0jet_PTH_GE10_2016_subplot,"tt_0jet_PTH_GE10_2016_subplot")
    #tt_boosted_1J_2018_sb = reBin(rb,tt_boosted_1J_2016_subplot,"tt_boosted_1J_2016_subplot") 
    #tt_boosted_GE2J_2018_sb = reBin(rb,tt_boosted_GE2J_2016_subplot,"tt_boosted_GE2J_2016_subplot")           
    #tt_vbf_PTH_0_200_2018_sb = reBin(rb,tt_vbf_PTH_0_200_2016_subplot,"tt_vbf_PTH_0_200_2016_subplot")
    #tt_vbf_PTH_GE_200_2018_sb = reBin(rb,tt_vbf_PTH_GE_200_2016_subplot,"tt_vbf_PTH_GE_200_2016_subplot")                                                     
    tt_0jet_PTH_0_10_2018_sb  = tt_0jet_PTH_0_10_2016_subplot
    tt_0jet_PTH_GE10_2018_sb  = tt_0jet_PTH_GE10_2016_subplot
    tt_boosted_1J_2018_sb     = tt_boosted_1J_2016_subplot
    tt_boosted_GE2J_2018_sb   = tt_boosted_GE2J_2016_subplot
    tt_vbf_PTH_0_200_2018_sb  = tt_vbf_PTH_0_200_2016_subplot
    tt_vbf_PTH_GE_200_2018_sb = tt_vbf_PTH_GE_200_2016_subplot
    #Merge the categories
    print "merging the categories"
    ...
    #Merge the categories
    print "merging the categories"
    masterDictionary=et_0jet_PTH_0_10_2017
    masterDictionary_sb=et_0jet_PTH_0_10_2017_sb
    ...
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    et_0jet_PTH_0_10_2018_prefit  = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"et_0jet_PTH_0_10_2016_prefit")                                                             

    rollingBins = [30.0,40.0,50.0,60.0,70.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    et_0jet_PTH_GE10_2018_prefit  = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"et_0jet_PTH_GE10_2016_prefit")

    rollingBins = [0.0,60.0,120.0,200.0,250.0,300.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    et_boosted_1J_2018_prefit     = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"et_boosted_1J_2016_prefit") 

    rollingBins=[0.0,60.0,120.0,200.0,250.0,300.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    et_boosted_GE2J_2018_prefit   = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"et_boosted_GE2J_2016_prefit")                                                                           

    rollingBins=[350.0,700.0,1000.0,1500.0,1800.0,10000.0]
    #recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    et_vbf_PTH_0_200_2018_prefit  = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"et_vbf_PTH_0_200_2016_prefit")

    rollingBins = [350.0,700.0,1200.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    et_vbf_PTH_GE_200_2018_prefit = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"et_vbf_PTH_GE_200_2016_prefit")                                                   

    #Rebin the histograms 
    print "combining bins"
    #et_0jet_PTH_0_10_2018  = reBin(rb,et_0jet_PTH_0_10_2016_prefit,"et_0jet_PTH_0_10_2016_prefit")       
    #et_0jet_PTH_GE10_2018  = reBin(rb,et_0jet_PTH_GE10_2016_prefit,"et_0jet_PTH_GE10_2016_prefit")
    #et_boosted_1J_2018     = reBin(rb,et_boosted_1J_2016_prefit,"et_boosted_1J_2016_prefit") 
    #et_boosted_GE2J_2018   = reBin(rb,et_boosted_GE2J_2016_prefit,"et_boosted_GE2J_2016_prefit")           
    #et_vbf_PTH_0_200_2018  = reBin(rb,et_vbf_PTH_0_200_2016_prefit,"et_vbf_PTH_0_200_2016_prefit")
    #et_vbf_PTH_GE_200_2018 = reBin(rb,et_vbf_PTH_GE_200_2016_prefit,"et_vbf_PTH_GE_200_2016_prefit")                                                     


    et_0jet_PTH_0_10_2018  = et_0jet_PTH_0_10_2016_prefit
    et_0jet_PTH_GE10_2018  = et_0jet_PTH_GE10_2016_prefit
    et_boosted_1J_2018     = et_boosted_1J_2016_prefit
    et_boosted_GE2J_2018   = et_boosted_GE2J_2016_prefit
    et_vbf_PTH_0_200_2018  = et_vbf_PTH_0_200_2016_prefit
    et_vbf_PTH_GE_200_2018 = et_vbf_PTH_GE_200_2016_prefit
    ...
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    et_0jet_PTH_0_10_2018_subplot  = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"et_0jet_PTH_0_10_2016_prefit")                                                             

    rollingBins = [30.0,40.0,50.0,60.0,70.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    et_0jet_PTH_GE10_2018_subplot  = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"et_0jet_PTH_GE10_2016_prefit")

    rollingBins = [0.0,60.0,120.0,200.0,250.0,300.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    et_boosted_1J_2018_subplot     = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"et_boosted_1J_2016_prefit") 

    rollingBins=[0.0,60.0,120.0,200.0,250.0,300.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    et_boosted_GE2J_2018_subplot   = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"et_boosted_GE2J_2016_prefit")                                                                           

    rollingBins=[350.0,700.0,1000.0,1500.0,1800.0,10000.0]
    #recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    et_vbf_PTH_0_200_2018_subplot  = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"et_vbf_PTH_0_200_2016_prefit")

    rollingBins = [350.0,700.0,1200.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    et_vbf_PTH_GE_200_2018_subplot = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"et_vbf_PTH_GE_200_2016_prefit")                                                   
    #Rebin the histograms 
    print "combining bins"
    #et_0jet_PTH_0_10_2018_sb = reBin(rb,et_0jet_PTH_0_10_2016_subplot,"et_0jet_PTH_0_10_2016_subplot")       
    #et_0jet_PTH_GE10_2018_sb = reBin(rb,et_0jet_PTH_GE10_2016_subplot,"et_0jet_PTH_GE10_2016_subplot")
    #et_boosted_1J_2018_sb = reBin(rb,et_boosted_1J_2016_subplot,"et_boosted_1J_2016_subplot") 
    #et_boosted_GE2J_2018_sb = reBin(rb,et_boosted_GE2J_2016_subplot,"et_boosted_GE2J_2016_subplot")           
    #et_vbf_PTH_0_200_2018_sb = reBin(rb,et_vbf_PTH_0_200_2016_subplot,"et_vbf_PTH_0_200_2016_subplot")
    #et_vbf_PTH_GE_200_2018_sb = reBin(rb,et_vbf_PTH_GE_200_2016_subplot,"et_vbf_PTH_GE_200_2016_subplot")                                                     
    et_0jet_PTH_0_10_2018_sb  = et_0jet_PTH_0_10_2016_subplot
    et_0jet_PTH_GE10_2018_sb  = et_0jet_PTH_GE10_2016_subplot
    et_boosted_1J_2018_sb     = et_boosted_1J_2016_subplot
    et_boosted_GE2J_2018_sb   = et_boosted_GE2J_2016_subplot
    et_vbf_PTH_0_200_2018_sb  = et_vbf_PTH_0_200_2016_subplot
    et_vbf_PTH_GE_200_2018_sb = et_vbf_PTH_GE_200_2016_subplot
    #Merge the categories
    print "merging the categories"
    ...
    #Merge the categories
    print "merging the categories"
    masterDictionary=em_0jet_PTH_0_10_2016
    masterDictionary_sb=em_0jet_PTH_0_10_2016_sb
    ...
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    em_0jet_PTH_0_10_2018_prefit  = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"em_0jet_PTH_0_10_2016_prefit")                                                             

    rollingBins = [30.0,40.0,50.0,60.0,70.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    em_0jet_PTH_GE10_2018_prefit  = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"em_0jet_PTH_GE10_2016_prefit")

    rollingBins = [0.0,60.0,120.0,200.0,250.0,300.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    em_boosted_1J_2018_prefit     = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"em_boosted_1J_2016_prefit") 

    rollingBins=[0.0,60.0,120.0,200.0,250.0,300.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    em_boosted_GE2J_2018_prefit   = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"em_boosted_GE2J_2016_prefit")                                                                           

    rollingBins=[350.0,700.0,1000.0,1500.0,1800.0,10000.0]
    #recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    em_vbf_PTH_0_200_2018_prefit  = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"em_vbf_PTH_0_200_2016_prefit")

    rollingBins = [350.0,700.0,1200.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    em_vbf_PTH_GE_200_2018_prefit = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"em_vbf_PTH_GE_200_2016_prefit")                                                   

    #Rebin the histograms 
    print "combining bins"
    #em_0jet_PTH_0_10_2018  = reBin(rb,em_0jet_PTH_0_10_2016_prefit,"em_0jet_PTH_0_10_2016_prefit")       
    #em_0jet_PTH_GE10_2018  = reBin(rb,em_0jet_PTH_GE10_2016_prefit,"em_0jet_PTH_GE10_2016_prefit")
    #em_boosted_1J_2018     = reBin(rb,em_boosted_1J_2016_prefit,"em_boosted_1J_2016_prefit") 
    #em_boosted_GE2J_2018   = reBin(rb,em_boosted_GE2J_2016_prefit,"em_boosted_GE2J_2016_prefit")           
    #em_vbf_PTH_0_200_2018  = reBin(rb,em_vbf_PTH_0_200_2016_prefit,"em_vbf_PTH_0_200_2016_prefit")
    #em_vbf_PTH_GE_200_2018 = reBin(rb,em_vbf_PTH_GE_200_2016_prefit,"em_vbf_PTH_GE_200_2016_prefit")                                                     


    em_0jet_PTH_0_10_2018  = em_0jet_PTH_0_10_2016_prefit
    em_0jet_PTH_GE10_2018  = em_0jet_PTH_GE10_2016_prefit
    em_boosted_1J_2018     = em_boosted_1J_2016_prefit
    em_boosted_GE2J_2018   = em_boosted_GE2J_2016_prefit
    em_vbf_PTH_0_200_2018  = em_vbf_PTH_0_200_2016_prefit
    em_vbf_PTH_GE_200_2018 = em_vbf_PTH_GE_200_2016_prefit
    ...
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    em_0jet_PTH_0_10_2018_subplot  = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"em_0jet_PTH_0_10_2016_prefit")                                                             

    rollingBins = [30.0,40.0,50.0,60.0,70.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    em_0jet_PTH_GE10_2018_subplot  = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"em_0jet_PTH_GE10_2016_prefit")

    rollingBins = [0.0,60.0,120.0,200.0,250.0,300.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    em_boosted_1J_2018_subplot     = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"em_boosted_1J_2016_prefit") 

    rollingBins=[0.0,60.0,120.0,200.0,250.0,300.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    em_boosted_GE2J_2018_subplot   = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"em_boosted_GE2J_2016_prefit")                                                                           

    rollingBins=[350.0,700.0,1000.0,1500.0,1800.0,10000.0]
    #recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    em_vbf_PTH_0_200_2018_subplot  = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"em_vbf_PTH_0_200_2016_prefit")

    rollingBins = [350.0,700.0,1200.0,10000.0]
    #recoBins = [50.0,70.0,90.0,110.0,130.0,150.0,170.0,210.0,250.0,9000.0]
    recoBins=[50.0,70.0,90.,110.,130.,150.0,170.0,210.0,250.0,300.0]
    recobw = [20.0,20.0,20.0,20.0,20.0,20.0,40.0,40.0,8750.0,10000.0]
    em_vbf_PTH_GE_200_2018_subplot = makePlots(fhisto,rerollfile,recoBins,rollingBins,recobw,rb,"em_vbf_PTH_GE_200_2016_prefit")                                                   
    #Rebin the histograms 
    print "combining bins"
    #em_0jet_PTH_0_10_2018_sb = reBin(rb,em_0jet_PTH_0_10_2016_subplot,"em_0jet_PTH_0_10_2016_subplot")       
    #em_0jet_PTH_GE10_2018_sb = reBin(rb,em_0jet_PTH_GE10_2016_subplot,"em_0jet_PTH_GE10_2016_subplot")
    #em_boosted_1J_2018_sb = reBin(rb,em_boosted_1J_2016_subplot,"em_boosted_1J_2016_subplot") 
    #em_boosted_GE2J_2018_sb = reBin(rb,em_boosted_GE2J_2016_subplot,"em_boosted_GE2J_2016_subplot")           
    #em_vbf_PTH_0_200_2018_sb = reBin(rb,em_vbf_PTH_0_200_2016_subplot,"em_vbf_PTH_0_200_2016_subplot")
    #em_vbf_PTH_GE_200_2018_sb = reBin(rb,em_vbf_PTH_GE_200_2016_subplot,"em_vbf_PTH_GE_200_2016_subplot")                                                     
    em_0jet_PTH_0_10_2018_sb  = em_0jet_PTH_0_10_2016_subplot
    em_0jet_PTH_GE10_2018_sb  = em_0jet_PTH_GE10_2016_subplot
    em_boosted_1J_2018_sb     = em_boosted_1J_2016_subplot
    em_boosted_GE2J_2018_sb   = em_boosted_GE2J_2016_subplot
    em_vbf_PTH_0_200_2018_sb  = em_vbf_PTH_0_200_2016_subplot
    em_vbf_PTH_GE_200_2018_sb = em_vbf_PTH_GE_200_2016_subplot
    #Merge the categories
    print "merging the categories"
    ...
    pad1 = ROOT.TPad("pad1","The pad",0.0016,0.0,1.0,1.0)
    pad2 = ROOT.TPad("pad2","The upper right pad",0.55,0.15,0.9,0.68)
    ...
    leg.AddEntry(masterDictionary["data_obs"],"Observed")
