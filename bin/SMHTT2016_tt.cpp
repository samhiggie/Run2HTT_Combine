...
int main(int argc, char **argv) 
{
  ...
  if(Input.OptionExists("-e")) cb.cp().process(JoinStr({sig_procs,{"VVL","VVT","ZL","ZT","TTL","TTT"}})).AddSyst(cb, "lumi_Run2016", "lnN", SystMap<>::init(1.023));
  else cb.cp().process(JoinStr({sig_procs,{"VVL","ZL","TTL"}})).AddSyst(cb, "lumi_Run2016", "lnN", SystMap<>::init(1.023));
