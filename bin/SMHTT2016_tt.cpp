...
int main(int argc, char **argv) 
{
  ...
  vector<string> bkg_procs = {"embedded","jetFakes","ZL","VVL","STL","TTL","ggH_hww","qqH_hww","WH_hww","ZH_hww"};
  ...
  cb.cp().process(JoinStr({{"ZT","VVT","ZL","VVL","ggH_hww","qqH_hww","WH_hww","ZH_hww"},sig_procs})).AddSyst(cb,"CMS_htt_eff_b","lnN",SystMap<>::init(1.005));
  ...
  if(not Input.OptionExists("-s"))
    {
      ...
      AddShapesIfNotEmpty({"CMS_prefiring"},
                          JoinStr({sig_procs,{"VVL","STL","ZL","TTL","ggH_hww","qqH_hww","WH_hww","ZH_hww"}}),
                          &cb,
                          1.00,
      ...
      AddShapesIfNotEmpty({"CMS_tauideff_dm0_2016","CMS_tauideff_dm1_2016","CMS_tauideff_dm10_2016","CMS_tauideff_dm11_2016"},
                          JoinStr({ggH_STXS,qqH_STXS,{"WH_htt","ZH_htt","ggH_hww","qqH_hww","WH_hww","ZH_hww"}}),
                          &cb,
                          1.00,
                          TheFile,CategoryArgs);
      ...
      AddShapesIfNotEmpty({"CMS_doubletautrg_dm0_2016","CMS_doubletautrg_dm1_2016","CMS_doubletautrg_dm10_2016","CMS_doubletautrg_dm11_2016"},
                          JoinStr({ggH_STXS,qqH_STXS,{"VVL","STL","TTL","ZL","WH_htt","ZH_htt","ggH_hww","qqH_hww","WH_hww","ZH_hww"}}),
                          &cb,
                          1.00,
                          TheFile,CategoryArgs);
      ...
      if (Input.OptionExists("-c"))
	{
	  AddShapesIfNotEmpty({"CMS_htt_boson_reso_met_0jet_2016","CMS_htt_boson_scale_met_0jet_2016",
	    ...
	    JoinStr({ggH_STXS,qqH_STXS,{"ZL","ggH_hww","qqH_hww"}}),
	    &cb,
	    1.00,
	    TheFile,CategoryArgs);
	}
	...
	JoinStr({ggH_STXS,qqH_STXS,{"WH_htt","ZH_htt","VVL","STL","ZL","TTL","ggH_hww","qqH_hww","WH_hww","ZH_hww"}}),
	&cb,
	1.000,
	TheFile,CategoryArgs);
